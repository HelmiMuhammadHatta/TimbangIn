...
export const MaterialTypes = () => {
  ...
  const columns = [
    { header: 'Kode', accessor: 'code' as keyof MaterialType },
    { header: 'Nama Material', accessor: 'name' as keyof MaterialType },
    { header: 'Satuan', accessor: 'unit' as keyof MaterialType },
    { header: 'Harga / Satuan', accessor: (row: MaterialType) => `Rp ${row.pricePerUnit.toLocaleString('id-ID')}` },
    {
      header: 'Status',
